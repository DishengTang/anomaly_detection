...
class Classifier(nn.Module):
    def __init__(self, dataset, device, args):
        ...
        self.MLP =  nn.Sequential(
                    ...
                    nn.Dropout(p=args.dropout),
                    nn.ELU(),
                    nn.BatchNorm1d(args.hidden, affine=False))
    ...
    def get_gate(self, x, edge_index):
        ...
        return context_gate.cpu().detach().numpy(), feature_gate.cpu().detach().numpy(), topology_gate.cpu().detach().numpy()
