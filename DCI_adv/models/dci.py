...
from layers import GraphCNN, AvgReadout, Discriminator, GCN, GAT, SpGAT
import sys
...
class DCI(nn.Module):
    def __init__(self, num_layers, num_mlp_layers, input_dim, hidden_dim, neighbor_pooling_type, device):
        ...
        # self.gin = GCN(input_dim, hidden_dim, device)
        # self.gin = SpGAT(input_dim, hidden_dim, 0.5, 0.2, 8)
